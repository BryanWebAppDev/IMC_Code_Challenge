...
namespace IMC_Code_Challenge_Tests
{
    public class TaxJarTaxCalculatorTests
    {
        ...
        public void Setup()
        {
            taxJarTaxCalculator = new TaxJarTaxCalculator();
        ...
        public async Task GetTaxRatesForLocation_Test()
        {
            ...
            try
            {
                result = await taxJarTaxCalculator.GetTaxRatesForLocation(locationForTaxRateTest);
            }
            catch
            {
        ...
        public async Task CalculateTaxesForOrder_Test()
        {
            ...
            try
            {
                result = await taxJarTaxCalculator.CalculateTaxesForOrder(orderForCalculateTaxTest);
            }
            catch
            {
                Assert.Fail("Should be able to run without errors.");
